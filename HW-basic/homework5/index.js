/*Опишіть своїми словами, що таке метод об'єкту
    Это какая то фукнция, который имеет обьект, спомощью него можно манипулировать обьектом. 
*/

/*Який тип даних може мати значення властивості об'єкта?
    Свойство обьекта может принимать любой тип данных.
*/

/*Об'єкт це посилальний тип даних. Що означає це поняття?
    Это значит, что данные обьекта хранятся в другом месте и наша переменная получает ссылку на этот обьект.
*/
